            ...
            <div className="bg-white/5 border border-white/10 p-4 rounded-xl flex-1 flex flex-col relative overflow-hidden min-h-0">
              ...
              <div className="mt-3 pt-3 border-t border-white/5 flex gap-2 shrink-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 px-2 py-1.5 bg-jade/10 border border-jade/30 rounded-lg text-[10px] text-jade flex items-center justify-center gap-1.5 transition-colors hover:bg-jade/20 hover:border-jade/50 cursor-pointer group"
                >
                  <ExternalLink className="w-3 h-3 text-jade" />
                  <span className="truncate font-bold tracking-widest">访问演示站点</span>
                </a>
              </div>
            </div>
          </div>
