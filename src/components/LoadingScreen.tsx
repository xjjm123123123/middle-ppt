...
export default function LoadingScreen() {
  ...
  return (
    <div
      className={`fixed inset-0 bg-[var(--color-bg-dark)] flex items-center justify-center z-[100] ${isExiting ? 'loading-screen-exit' : ''}`}
    >
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="loading-fade-in text-bronze/80 text-sm tracking-[0.3em] uppercase">加载中...</div>
      </div>
    </div>
  );
}
